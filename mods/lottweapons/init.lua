...
minetest.register_tool("lottweapons:scepter", {
	description = "Scepter",
	inventory_image = "lottweapons_scepter.png",
	on_use = function(itemstack, user, pointed_thing)
		...
		if closeflagdistance and closeflag then
			...
			minetest.chat_send_player(user:get_player_name(), "There are no flags on this map!")
		end
		return
	end,
	tool_capabilities = {
